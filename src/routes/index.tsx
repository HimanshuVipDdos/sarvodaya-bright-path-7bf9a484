          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex-1">
              <motion.h1
                ...
                className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.15] tracking-tight"
              >
              ...
              <motion.p
                ...
                className="mt-6 text-slate-600 text-lg sm:text-xl max-w-lg"
              >
