        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-12 sm:px-6 sm:pt-20 lg:pb-28">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <motion.h1 variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="mt-6 text-balance text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl">
                Crack India's toughest{" "}
                <span className="text-gradient">competitive exams</span>{" "}
                with confidence.
              </motion.h1>
              
              <motion.p variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="mt-6 max-w-xl text-lg text-muted-foreground sm:text-xl">
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="mt-12 grid max-w-md grid-cols-3 gap-4">
                {[
                  { k: "1K+", v: "Aspirants" },
                  { k: "500+", v: "Selections" },
                  { k: "13+", v: "Batches" },
