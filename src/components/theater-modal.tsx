      ...
      <div className="flex-1 overflow-y-auto min-h-0 bg-[#F8F9FA]">
        <div className="mx-auto max-w-6xl p-4 sm:p-6 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-4">
            ...
            {/* Action Buttons: ONLY Share Button (Like/Dislike/Save Removed) */}
            <div className="flex items-center gap-2">
              <button
                onClick={handleShare}
                className="flex items-center gap-1.5 rounded-full bg-white border border-slate-200 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 shadow-xs transition active:scale-95"
              >
