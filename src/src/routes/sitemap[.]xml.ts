    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/current-affairs", changefreq: "daily", priority: "0.8" },
          { path: "/free-study-material", changefreq: "weekly", priority: "0.7" },
          { path: "/notifications", changefreq: "daily", priority: "0.8" },
